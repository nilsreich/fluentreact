...
import { Stack, Text, Pivot, PivotItem, Label,DefaultEffects, DefaultButton, CommandBarButton, IconButton, PrimaryButton } from '@fluentui/react';
      ...
      <Stack horizontal style={{ height: 'calc(100% - 24px)' }}>
        ...
        <Stack.Item grow style={{ backgroundColor: NeutralColors.gray10, padding: 36 }}>
          <div >
            ...
            <Pivot aria-label="Basic Pivot Example" style={{boxShadow: DefaultEffects.elevation4, height:'60vh', paddingLeft:16, backgroundColor:'white'}}>
              <PivotItem
                headerText="Recent"
                headerButtonProps={{
                  'data-order': 1,
